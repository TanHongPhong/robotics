    ...
    def __init__(self):
        ...
        self.system_message = {
            ...
            "content": (
                ...
                "QUY TẮC BẮT BUỘC:\n"
                "- Nếu user yêu cầu thay đổi inventory (xóa ô, sửa tên hàng, chọn lấy, bỏ chọn, đánh dấu đã lấy) "
                "→ action PHẢI là \"update_inventory\".\n"
                "- Với action=\"update_inventory\" thì updates PHẢI có ít nhất 1 phần tử.\n"
                "- \"xóa hàng ở ô N\" nghĩa là: product=\"\" và pick=false và done=false tại cell_id=N.\n"
                "- \"xóa/clear ô N\" = xóa hàng ở ô N.\n"
                "- Không được trả lời \"Đã xóa...\" nếu action=\"none\".\n"
                ...
                "MAPPING CỤ THỂ:\n"
                "- 'xóa hàng ở ô N / xóa ô N / clear ô N' → {\"cell_id\": N, \"product\": \"\", \"pick\": false, \"done\": false}\n"
                "- 'chọn/lấy X' → tìm item có product=X, set {\"cell_id\": ..., \"pick\": true, \"done\": false}\n"
                "- 'bỏ chọn ô N' → {\"cell_id\": N, \"pick\": false, \"done\": false}\n"
                "- 'đã lấy xong ô N' → {\"cell_id\": N, \"done\": true}\n"
                "- 'thêm/cho X vào ô Y' → {\"cell_id\": Y, \"product\": X, \"pick\": true, \"done\": false}\n\n"
                
                "VÍ DỤ:\n"
                "User: 'Xóa hàng ở ô 1'\n"
                "Response: {\"action\": \"update_inventory\", \"reply\": \"Đã xóa hàng ở ô 1\", \"updates\": [{\"cell_id\": 1, \"product\": \"\", \"pick\": false, \"done\": false}]}\n\n"
                
                "User: 'Cho nước suối vào ô 4'\n"
                "Response: {\"action\": \"update_inventory\", \"reply\": \"Đã thêm nước suối vào ô 4\", \"updates\": [{\"cell_id\": 4, \"product\": \"Nước suối\", \"pick\": true, \"done\": false}]}\n\n"
                
                "User: 'Bỏ chọn ô 2'\n"
                "Response: {\"action\": \"update_inventory\", \"reply\": \"Đã bỏ chọn ô 2\", \"updates\": [{\"cell_id\": 2, \"pick\": false, \"done\": false}]}\n\n"
